...
exports.default = _angular2.default.module('perfect_scrollbar', []).directive('perfectScrollbar', ['$parse', '$window', function ($parse, $window) {
    ...
    return {
        ...
        link: function link($scope, $elem, $attr) {
            var jqWindow = _angular2.default.element($window);
            var options = {};
            ...
            $scope.$evalAsync(function () {
                _perfectScrollbar2.default.initialize($elem[0], options);
                ...
                $scope.$evalAsync(function () {
                    if ($attr.scrollDown == 'true' && event != 'mouseenter') {
                        setTimeout(function () {
                            ...
                            _perfectScrollbar2.default.update($elem[0]);
                            return;
